...
import com.skyhouse.projectrpg.net.packets.ClientReadyResponse;
...
public class NetworkUtils {
	...
	public static void registerKryoClass(Kryo kryo) {
		...
		kryo.register(ClientReadyResponse.class);
		kryo.register(CreateCharacterRequest.class);
		kryo.register(CreateCharacterResponse.class);
		kryo.register(ConnectToPlayRequest.class);
		kryo.register(ConnectToPlayResponse.class);
